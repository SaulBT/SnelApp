...
public class InstructorPruebas
{
    ...
    private readonly ServicioInstructor _servicioInstructor;
    ...
    public InstructorPruebas()
    {
        ...
        _logger = NullLogger<ServicioInstructor>.Instance;

        _servicioInstructor = new ServicioInstructor(_instructorDAO, _validaciones, _logger);
    }
